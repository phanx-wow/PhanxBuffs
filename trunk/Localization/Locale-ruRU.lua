...
--	["Use this panel to adjust some basic settings for buff, debuff, and weapon buff icons."] = "",
	...
	["Select the side of the screen from which buffs and debuffs grow."] = "Установить какой стороне экрана значки привязан.",
	["Left"] = "Слева",
	["Right"] = "Справа",
	["Typeface"] = "Шрифт",
--	["Select the typeface for the stack count and timer text."] = "",
	["Text Outline"] = "Контур шрифта",
	["Select the outline weight for the stack count and timer text."] = "Настроить контура шрифта.",
	["None"] = "Нету",
	["Thin"] = "Тонкий",
	["Thick"] = "Толстый",
