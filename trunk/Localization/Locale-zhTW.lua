...
-- Configuration panel
	...
	["Growth Anchor"] = "描點對齊",
	["Select the side of the screen from which buffs and debuffs grow."] = "設置buff和debuff從屏幕哪邊對齊",
	["Left"] = "左",
	["Right"] = "右",
	["Typeface"] = "字型",
	["Select the typeface for the stack count and timer text."] = "設置層數和時間文字字型",
	["Text Outline"] = "文本輪廓",
	["Select the outline weight for the stack count and timer text."] = "設置層數和時間文字輪廓",
	["None"] = "無",
	["Thin"] = "細",
	["Thick"] = "粗",
--	["Text Size"] = "",
