...
-- Configuration panel text
	...
	["Set the typeface for stack count and timer text."] = "Establecer el tipo de letra del texto de las aplicaciones y el tiempo.",
	["Text Outline"] = "Perfil de texto",
	["Set the outline weight for stack count and timer text."] = "Establecer el grueso del perfil del texto de las aplicaciones y el tiempo.",
	["None"] = "Ninguno",
	["Thin"] = "Fino",
	["Thick"] = "Grueso",
