...
-- Configuration panel text
	...
	["Use this panel to adjust some basic settings for buff, debuff, and weapon buff icons."] = "Utilice el este panel para cambiar algunos ajustes básicos para los iconos de beneficios, de perjuicios, y de beneficios de armas.",
	["Buff Size"] = "Tamaño de beneficios",
	["Set the size of each buff icon."] = "Fije el tamaño de cada icono de bufo.",
	["Buff Spacing"] = "Espaciamiento de beneficios",
	["Set the space between buff icons."] = "Fije el espaciamiento entre los iconos de beneficios.",
	["Buff Columns"] = "Columnas de beneficios",
	["Set the number of buff icons to show on each row."] = "Fije el número de iconos de beneficios para mostrar en cada fila.",
	["Debuff Size"] = "Tamaño de perjuicios",
	["Set the size of each debuff icon."] = "Fije el tamaño de cada icono de perjuicios.",
	["Debuff Spacing"] = "Espaciamiento de perjuicios",
	["Set the space between debuff icons."] = "Fije el espaciamiento entre los iconos de perjuicios.",
	["Debuff Columns"] = "Columnas de perjuicios",
	["Set the number of debuff icons to show on each row."] = "Fije el número de iconos de perjuicios para mostrar en cada fila.",
	["Typeface"] = "Tipografía",
	["Set the typeface for stack count and timer text."] = "Fije la tipografía para los textos del contador del apilado y de tiempo.",
	["Text Outline"] = "Esquema de texto",
	["Set the outline weight for stack count and timer text."] = "Fije el grueso del esquema para los textos del contador del apilado y de tiempo.",
	["None"] = "Ninguno",
	["Thin"] = "Fino",
	["Thick"] = "Grueso",
	["Growth Anchor"] = "Ancla de iconos",
	["Set the side of the screen from which buffs and debuffs grow."] = "Fije el lado de la pantalla de la cual crecen beneficios y perjuicios.",
	["Left"] = "Izquierda",
	["Right"] = "Derecha",
	...
	["Lock the buff and debuff frames in place, hiding the backdrop and preventing them from being moved."] = "Bloquear celdas de beneficios y perjuicios, para ocultar el fondo y permitar el movimiento.",
