...
-- Configuration panel
	...
	["Select the side of the screen from which buffs and debuffs grow."] = "버프와 디버프가 성장할 화면의 측면을 설정합니다.",
	["Left"] = "왼쪽",
	["Right"] = "오른쪽",
	["Typeface"] = "글꼴",
	["Select the typeface for the stack count and timer text."] = "중첩 카운트와 타이머 텍스트를 위해 글꼴을 설정합니다.",
	["Text Outline"] = "글꼴 외각선",
	["Select the outline weight for the stack count and timer text."] = "중첩 카운트와 타이머 텍스트를 위해 외곽선 두께를 설정합니다.",
	["None"] = "없음",
	["Thin"] = "얇게",
	["Thick"] = "두껍게",
	["Text Size"] = "글꼴 크기",
