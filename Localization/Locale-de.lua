...
-- Configuration panel
	...
	["Now ignoring buff: %s"] = "Stärkungszauber wird jetzt ignoriert: %s",
	["Now ignoring debuff: %s"] = "Schwächungszauber wird jetzt ignoriert: %s",
	["No longer ignoring buff: %s"] = "Stärkungszauber wird nicht mehr ignoriert: %s",
	["No longer ignoring debuff: %s"] = "Schwächungszauber wird nicht mehr ignoriert: %s",
