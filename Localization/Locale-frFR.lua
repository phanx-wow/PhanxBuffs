...
-- Configuration panel
	...
	["Select the side of the screen from which buffs and debuffs grow."] = "Configure le côté de l'écran à partir duquel les buffs et débuffs apparaîtront.",
	["Left"] = "Gauche",
	["Right"] = "Droite",
	["Typeface"] = "Police",
	["Select the typeface for the stack count and timer text."] = "Configure la police de texte des compteurs de stack et du timer.",
	["Text Outline"] = "Contour du Texte",
	["Select the outline weight for the stack count and timer text."] = "Configure l'épaisseur du contour des textes de stack et timer.",
	["None"] = "Aucun",
	["Thin"] = "Fin",
	["Thick"] = "Epais",
--	["Text Size"] = "",
